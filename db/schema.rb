...
ActiveRecord::Schema.define(version: 2022_03_24_201617) do
  ...
  create_table "actions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "name"
    t.bigint "device_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "client_admins", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "name"
    t.bigint "oem_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "endpoint_keys", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "oem_businesses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "name"
    t.bigint "oem_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "oem_businesses_authors", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "oem_businesses_operators", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "oem_business_id"
  ...
  create_table "oem_businesses_procedures", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "oem_business_id"
    t.bigint "procedure_id"
  ...
  create_table "oems", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "operators", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "name"
    t.boolean "deactivated", default: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "parlaty_admins", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "procedures", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "name"
    t.float "version"
    t.text "description"
    t.string "category"
