...
ActiveRecord::Schema.define(version: 2022_04_06_181915) do
  ...
  create_table "client_admins", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.bigint "oem_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "endpoint_keys", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "oem_businesses_procedures", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "oem_business_id"
    t.bigint "procedure_id"
