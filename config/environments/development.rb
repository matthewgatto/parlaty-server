Rails.application.configure do
  ...
  # remove since my system cannot update system parameter config.file_watcher = ActiveSupport::EventedFileUpdateChecker
  ...
  config.action_mailer.smtp_settings = {
    ...
    domain:         'localhost:3000', #gmail.com works too ???
