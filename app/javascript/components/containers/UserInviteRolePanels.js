...
export default ({formKey}) => {
  ...
  const options = role === "ParlatyAdmin" ? [{value: "parlatyadmin", label: "Parlaty Admin"}, {value: "clientadmin", label: "Client Admin"}, {value: "author", label: "Author"}, {value: "operator", label: "Operator"}] : [{value: "clientadmin", label: "Client Admin"}, {value: "author", label: "Author"}, {value: "operator", label: "Operator"}]
  return(<>
