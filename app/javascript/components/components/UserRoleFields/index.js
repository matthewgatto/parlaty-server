  ...
  switch (role.toLowerCase()) {
    ...
    case "operator":
      return <>
        ...
        <UserOemBusinesses formKey={formKey} defaultValue={initialValues.oem_business_ids} defaultClient={defaultClient} oemBusinesses={isClientAdmin  && user.oem_business_ids} />
      </>
    case "parlatyadmin":
      if(placeholder){
