export const getParameterError = (formKey) => ({form}) => form[formKey] && form[formKey].errors && form[formKey].errors.fieldErrors && form[formKey].errors.fieldErrors.parameter_value_8_pack ? "This field is required" : null
