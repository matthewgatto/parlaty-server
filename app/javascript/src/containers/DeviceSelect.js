...
const DeviceSelectContainer = ({root, value, defaultDevice, ...props}) => {
  ...
  return(<>
    ...
    <ActionList actions={actions} root={root} defaultActions={(defaultDevice && defaultDevice.id == value) ? defaultDevice.actions : undefined} />
  </>)
}
