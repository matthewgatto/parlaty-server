...
import { handleEntityCreateSubmit, clearForm, setCreateMeta, reorderStep, setStep } from '../redux/actions';
...
export default connect(
  null,
  {handleEntityCreateSubmit, clearForm, setCreateMeta, reorderStep, setStep}
)(CreateProcedureForm);
