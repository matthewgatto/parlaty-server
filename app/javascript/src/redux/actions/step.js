...
export const addStepForm = (formValues, isDuplicate) => ({type: types.ADD_STEP_FORM, payload: {id: uuid(), isOpen: true, formValues, isDuplicate}})
export const removeStepForm = (idx) => ({type: types.REMOVE_STEP_FORM, payload: idx})
export const reorderStep = (from, to, procedure_id) => ({type: types.REORDER_STEP_REQUEST, payload: {from, to, procedure_id}})
